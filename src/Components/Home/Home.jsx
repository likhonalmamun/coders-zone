  ...
  return (
    <>
      <div
       ...
       sm:p-7 p-2 md:pb-[50px] border-y-2 rounded-xl shadow-md text-2xl lg:text-5xl md:text-4xl xl:text-7xl font-bold "
      >
      ...
      <div
        className="lg:w-[80%] w-[92%] xl:w-[75%]  mx-auto text my-20 md:my-[120px]  text-rose-500
